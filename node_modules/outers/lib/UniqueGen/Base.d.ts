export declare class UniqueGen {
    #private;
     ...
     */
    RandomNumber(withzero?: boolean, CustomNumbers?: number[]): number;
    /**
     ...
     */
    RandomWord(isCAPITAL?: boolean, CustomWords?: string[]): string;
    /**
     ...
     */
    RandomMixed(isCAPITAL?: boolean, CustomMixeds?: string[]): string;
    /**
     ...
     */
    RandomSymbol(CustomSymbols?: string[]): string;
    /**
