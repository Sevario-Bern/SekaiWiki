...
const MixedGen_1 = __importDefault(require("../gen/MixedGen")); // function for generating a random word
 ...
 */
function GenerateMixedID(length = 1, isCAPITAL = false, CustomMixeds) {
    ...
    let Result = (0, MixedGen_1.default)(length, CustomMixeds !== undefined ? CustomMixeds : Mixed); // Generate the Random Number
...
exports.default = GenerateMixedID;
//# sourceMappingURL=MixedFunction.js.map