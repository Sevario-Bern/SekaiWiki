 ...
 */
function PostFetch(API, Data, Responsejson = true, Headers) {
 ...
 * @returns a Promise that resolves to an any value.
 */
function GetFetch(API, Responsejson = true, Headers) {
    return __awaiter(this, void 0, void 0, function* () {
        const Response = yield fetch(API, {
            method: "GET",
            headers: Headers,
 ...
 * @returns a Promise that resolves to an any value.
 */
function PutFetch(API, Data, Responsejson = true, Headers) {
    return __awaiter(this, void 0, void 0, function* () {
        const Response = yield fetch(API, {
            method: "PUT",
            headers: Headers,
 ...
 * @returns a Promise that resolves to an any value.
 */
function DeleteFetch(API, Responsejson = true, Headers) {
    return __awaiter(this, void 0, void 0, function* () {
        const Response = yield fetch(API, {
            method: "DELETE",
            headers: Headers,
