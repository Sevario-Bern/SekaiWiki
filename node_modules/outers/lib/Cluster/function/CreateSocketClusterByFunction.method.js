...
const ws_1 = require("ws"); // Import WebSocket module
 ...
 */
function SocketClusterConfig(ExpressServer = (0, express_1.default)(), // Main Express Server Instance
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isPrimary) {
            ...
            try {
                ...
                const WebSocketServerInstance = new ws_1.WebSocketServer({
                    server: ActiveServer,
                });
                // WebSocket connection handler
                WebSocketServerInstance.on("connection", (ws) => {
                    (0, Console_log_1.green)("WebSocket client connected");
                    ws.on("message", (message) => {
                        (0, Console_log_1.blue)(`Received message: ${message}`);
                    });
                    ws.on("close", () => {
                        (0, Console_log_1.red)("WebSocket client disconnected");
                    });
                });
...
exports.default = SocketClusterConfig;
//# sourceMappingURL=CreateSocketClusterByFunction.method.js.map